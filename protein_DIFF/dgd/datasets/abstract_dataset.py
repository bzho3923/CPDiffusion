...
class AbstractDatasetInfos:
    ...
    def compute_input_output_dims(self, datamodule, extra_features, domain_features):
        ...
        ex_dense, node_mask ,_ = utils.to_dense(example_batch.x, example_batch.edge_index, example_batch.edge_attr,
                                             example_batch.batch,example_batch.extra_x)
        ...
        try: # adding more information on node feature , such as SASA, diherdial , mu_r_norm
            self.input_dims['X'] += example_batch.extra_x.size(-1)
