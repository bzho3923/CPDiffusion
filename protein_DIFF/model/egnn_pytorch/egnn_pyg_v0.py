...
class EGNN_Sparse(MessagePassing):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.message_input_dim = (fourier_features * 2) + edge_attr_dim + (feats_dim * 2) #Fourier *2 + edge_attr + rel_dist + x_i + x_j
    ...
    def forward(self, x: Tensor, edge_index: Adj,
        ...
        if exists(edge_attr):
            edge_attr_feats =edge_attr# torch.cat([edge_attr, rel_dist], dim=-1)
        else:
